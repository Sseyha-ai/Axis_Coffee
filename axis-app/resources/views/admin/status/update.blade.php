...
<div class="dashboard-wrapper">
    <div class="container-fluid  dashboard-content">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <h5 class="card-header">Update Status 
                    <button class="btn btn-space btn-success"><a href="{{route('status-list')}}" style="color: #fff">Back</a> </button>
                    
                </h5>
               
                <div class="card-body">
                    <form id="form" data-parsley-validate="" novalidate="" method="POST" action="{{route('update-status',$rows->id)}}">
                       
                        @csrf
                        <div class="form-group row">
                            <label for="name" class="col-3 col-lg-2 col-form-label text-right">Name</label>
                            <div class="col-9 col-lg-10">
                                <input id="name" type="text" required=""  placeholder="Statuss name" name="name" class="form-control" autofocus value="{{$rows->name?? old('name')}}">
                            </div>
