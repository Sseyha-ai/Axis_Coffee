...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
    <div class="card">
        ...
        <div class="card-body">
            <form id="form" data-parsley-validate="" novalidate="" method="POST" action="{{route('update-position',$rows->id)}}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9 col-lg-10">
                        <input id="name" type="text" required=""  placeholder="Position name" name="name" class="form-control" value="{{$rows->name?? old('name')}}">
                    </div>
