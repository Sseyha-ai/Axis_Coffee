                    ...
                    <div class="tab-regular">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="container">
                                    {{-- <h2 class="fw-bold">Product Order Form</h2>
                                    <p class="text-muted">Please make sure to fill in the required fields and submit this form to complete your order.</p>
                                    ...
                                    <form>
                                      <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                          <div class="card p-2 border-primary">
                                            <div class="form-check mb-2">
                                              <input class="form-check-input" type="checkbox" checked id="product1">
                                            </div>
                                            <img style="height: 120px; width: 100px" src="{{asset('admin/assets/images/axis/pic4.jpg')}}" class="card-img-top img-fluid" alt="T-Shirt">
                                            <div class="card-body">
                                              <h5 class="card-title">Black Milk Tea</h5>
                                              <p class="text-primary fw-semibold">5,000 Riel</p>
                                              <div class="row mb-2">
                                                <div class="col">
                                        ...
                                        <div class="col-md-4">
                                          <div class="card p-2">
                                            ...
                                            <img src="https://via.placeholder.com/150x150?text=Sweatshirt" class="card-img-top img-fluid" alt="Sweatshirt">
                                            <div class="card-body">
                                              <h5 class="card-title">Sweatshirt</h5>
                                              <p class="text-primary fw-semibold">$5.00</p>
                                              <div class="row mb-2">
                                                <div class="col">
                                                  <label class="form-label">Quantity</label>
                                                  <select class="form-select">
                                              ...
                                              <label class="form-label">Sweatshirt Size</label>
                                              <select class="form-select">
                                                <option>XS</option>
                                                <option>S</option>
                                                <option>M</option>
                                        ...
                                        <div class="col-md-4">
                                          <div class="card p-2">
                                            ...
                                            <img src="https://via.placeholder.com/150x150?text=Shoes" class="card-img-top img-fluid" alt="Shoes">
                                            <div class="card-body">
                                              <h5 class="card-title">Shoes</h5>
                                              <p class="text-primary fw-semibold">$10.00</p>
                                              <div class="row mb-2">
                                                <div class="col">
                                                  <label class="form-label">Quantity</label>
                                                  <select class="form-select">
                                      ...
                                      <div class="d-flex justify-content-end">
                                        <h5>Total <span class="ms-3">$3.00</span></h5>
                                      </div>
                                    </form>
                                  </div>
