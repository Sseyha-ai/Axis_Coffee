    ...
    <div class="container-fluid  dashboard-content">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="form" data-parsley-validate="" novalidate="" method="POST" action="{{route('store-product')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-9 col-lg-10">
                                        <div>
                                            ...
                                            <input id="name" type="text" required=""  placeholder="Product Name" name="name" class="form-control"  autofocus >
                                        </div>
                                        
                                        <div>
                                            <label for="name" class="  col-form-label text-right">Category</label>
                                            <select name="category" id="" class="form-select form-control form-select-lg  px-2  w-15">
                                        ...
                                        <div>
                                            ...
                                            <input id="price" type="text" required=""  placeholder="Price" name="price" class="form-control"   >
                                        </div>
                                        <div>
                                            <label for="descr" class=" col-form-label text-right">Description</label>
                                            <input id="description" type="text" required=""  placeholder="description" name="description" class="form-control"   >
                                        </div>
                            </div>
